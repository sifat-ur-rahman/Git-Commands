...
### প্রয়োজনীয় কমিট কমান্ডসমূহ

| Command | Description |
| ------- | ----------- |
| `git add .` | সব নতুন এবং পরিবর্তিত ফাইল স্টেজিং এরিয়ায় যোগ করা |
| `git commit -m "[commit message]"` | পরিবর্তনসমূহ কমিট করা |
| `git push` | রিমোট রিপোজিটরিতে পরিবর্তনগুলো পাঠানো (মনে রাখা ব্রাঞ্চে) |
